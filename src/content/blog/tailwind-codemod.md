...
based class names that were created using TailwindCSS had to be changed across 1000+ React components. 
The
...
The newer config file, `tailwind.config.mjs`, was set up like this:
